...
export function comprobador(isWin:number) {
    if (isWin == 2 && botonRetirarse && botonDOMVolver && botonDameCarta) {
    ...
    else if (isWin == 1 && botonRetirarse && botonDOMVolver && botonDameCarta) {
