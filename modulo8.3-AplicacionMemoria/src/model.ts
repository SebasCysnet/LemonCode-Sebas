...
export let parejaAComprobar: InfoCarta[] = []
export function vaciarArrayComprobador() {
    parejaAComprobar = []
}
export let indexCartasVolteadasDOM: number[] = []
export function vaciarArrayCartasVolteadasDOM() {
    indexCartasVolteadasDOM = []
}